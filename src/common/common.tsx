export const projects = [
    {
        ...
        image: '../assets/img/matthew-smith-rFBA42UFpLs-unsplash.jpg',
        link: "https://github.com/HZ-2000/Personal-Website-V2"
    },
    {
        name: "Pomodoro Timer",
        description: "A web page with a journal style log and a pomodoro timer to help with productivity.",
        image: '../../assets/img/blackieshoot-Y8HRUhP-rkM-unsplash.jpg',
    ...
    },
    {
        ...
        image: '../assets/img/nicholas-ismael-martinez-LsmKRNXnyyA-unsplash.jpg',
